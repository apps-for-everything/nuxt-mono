...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/zb1o3y7iDz)
...
```sh
npx nx serve vue-mono
```

To create a production bundle:

```sh
npx nx build vue-mono
```

To see all available targets to run for a project, run:

```sh
npx nx show project vue-mono
```
